...
os.system('cmd /c pscp -pw [password] [email]:/its/home/mel29/breath/webservice/*.json "C:\\Users\\max_l\\OneDrive - University of Sussex\\4. Breath Awareness\\materials_code\\webservice"')
...
file_list = glob.glob('C:/Users/max_l/OneDrive - University of Sussex/4. Breath Awareness/materials_code/webservice/*.json')
...
dataset.to_csv('C:/Users/max_l/OneDrive - University of Sussex/4. Breath Awareness/materials_code/dataset.csv')
...
for index, row in dataset.iterrows():
    ...
    if last_survey == 'post'  or (row['condition'] == 'control' and (elapsed.days < 23 or elapsed.days > 24)):  #or elapsed.days < 3??
...
#####PREVIOUS STMP VERSION, NOW DISALLOWED ON G-MAIL########################################################
    ###SEND EMAIL
