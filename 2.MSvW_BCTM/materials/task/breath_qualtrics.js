Qualtrics.SurveyEngine.addOnload(function () {
    ...
    function makeTone(tone, seconds){ // https://stackoverflow.com/questions/34708980/generate-sine-wave-and-play-it-in-the-browser
        //parameters from here https://www.biorxiv.org/content/10.1101/504274v1.full.pdf
        const volume = 0.5
        let wave_points = []
        ...
        let timer_var = setInterval(function(){
            ...
            if (--total_sec < 0){ //timer hits 0, clear listeners and loop, setup or end exp trials
                ...
                if(timer_text.innerHTML === 'practice'){ //end prac, set up exp
                    ...
                    Qualtrics.SurveyEngine.setEmbeddedData( 'BCT-M', JSON.stringify(p_data)) //make sure this exists in experiment flow as well
                    saveData()
    ...
    function saveData(){
        ...
        xhr.open('POST', 'https://users.sussex.ac.uk/mel29/BCT-M/breath.php', true) // CHANGE THIS FOR PRE OR POST TEST ##########
