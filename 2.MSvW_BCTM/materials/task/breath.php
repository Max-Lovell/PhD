...
if (isset($post_data['file_name']) == true) {
    ...
    $file_name = filter_var($file_name, FILTER_VALIDATE_REGEXP, array('options'=>array('regexp'=>'/^[0-9]{5,6}_breath_p(re|ost)$/')));//\_(gabor|dots|breath|span)
} else {exit;}

file_put_contents("../../BCT-M/$file_name.json", $data);//https://stackoverflow.com/questions/43519007/usage-of-http-raw-post-data
