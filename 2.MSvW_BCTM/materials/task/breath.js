    ...
    let timer_var = setInterval(function(){
        ...
        if (--total_sec < 0){ //timer hits 0, clear listeners and loop, setup or end exp trials
            ...
            if(timer_text.innerHTML === 'practice'){ //end prac, set up exp
                ...
                } else { end_delay = 'This task is over. You will be forwarded to the next task automatically.' }
...
function saveData(sbj_id,next_task){
    ...
    xhr.open('POST', 'https://users.sussex.ac.uk/mel29/breath/breath.php', true)
